const teams = [
  {
    ...
    description:
      "SWiFT is the innovation office. It arms our people with the skills, expertise and resources to solve day-to-day problems with innovation.",
  ...
  {
    name: "CyberDef",
    subtitle: "Cyber Defence Branch",
    description: "This office ensures the cybersecurity of our systems.",
