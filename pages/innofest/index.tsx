import {
  ...
  import { primary, secondary, nYellow, nGreen, nSecondary } from "@afnexus/hummingbird-ui-assets";
          ...
          >
            ...
            >
              ...
              <Text fontSize="2xl" mb={5}>
                <Text as="span" color={nYellow[400]}>SW<i>i</i>FT</Text> and <Text as="span" color={nYellow[400]}>ACC</Text> are proud to bring you <b>InnoFest 22/23</b> - a two day event that showcases our innovator's efforts, 
              ...
              <TableContainer backgroundColor={primary[1000]}>
                <Table variant='simple'>
                  <Thead>
                    <Tr>
                      <Th><Text fontSize="lg" color={nYellow[400]}>Date / Month</Text></Th>
                      <Th><Text fontSize="lg" color={nYellow[400]}>Event</Text></Th>
                    </Tr>
                  </Thead>
                  <Tbody>
                    <Tr>
                      <Td>Jan 2023 to Feb 2023</Td>
                      <Td><Link href="#solvathon" color={nYellow[400]}><b>The Solva-thon</b></Link></Td>
                    </Tr>
                    <Tr>
                      <Td>23 Feb 2023</Td>
                      <Td>
              ...
              <Grid templateColumns='repeat(4, 1fr)' gap={3} backgroundColor={primary[800]}>
                {[
                  ...
                  <GridItem w='100%'>
                  <Image align="center" src={imageURL} height="100%"/>
                </GridItem>
                ))}
              </Grid>
            ...
            >
              ...
              <List spacing={3}>
                ...
                <ListItem>
                  <ListIcon as={ChevronRightIcon} color={nGreen[400]} float="left"/>
